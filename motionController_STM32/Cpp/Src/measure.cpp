...
#endif
//$endskip${QP_VERSION} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//$define${Shared::CMeasure} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace APP {

//${Shared::CMeasure} ........................................................

//${Shared::CMeasure::UpdateElapsedTime} .....................................
...
//${Shared::CMeasure::Start} .................................................
void CMeasure::Start() {
    m_intervalStartTime = getMicros();
}

//${Shared::CMeasure::CMeasure} ..............................................
CMeasure::CMeasure()
: kIntervalOffset(4)
{}

} // namespace APP
//$enddef${Shared::CMeasure} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
