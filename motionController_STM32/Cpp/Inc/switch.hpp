//$file${.::../Inc::switch.hpp} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
//
...
//${AOs::Switch} .............................................................
class Switch : public QP::QActive {
public:
    static Switch inst;
    std::uint8_t m_state;
...
private:
    ...
    void SendSwitchEvent(uint8_t state);
    uint8_t CheckSwitchChanged();
...
protected:
    ...
    Q_STATE_DECL(updateSwitchState);
    Q_STATE_DECL(readSwitch);
}; // class Switch
